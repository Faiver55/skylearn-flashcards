	...
	public function enqueue_scripts() {
		...
		wp_localize_script( $this->plugin_name . '-admin', 'skylearn_admin', array(
			...
			'strings'     => array(
				...
				'confirm_remove_card'   => __( 'Are you sure you want to remove this flashcard?', 'skylearn-flashcards' ),
				'confirm_bulk_action'   => __( 'Are you sure you want to perform this action?', 'skylearn-flashcards' ),
				...
				'no_items_selected'     => __( 'Please select items first.', 'skylearn-flashcards' ),
			),
		) );
