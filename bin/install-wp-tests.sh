...
# This script is used by CI/CD and local development
...
if [[ $WP_VERSION =~ ^[0-9]+\.[0-9]+\-(beta|RC)[0-9]+$ ]]; then
	...
	# http serves a single offer, whereas https serves multiple. HTTP is faster and more reliable for testing.
